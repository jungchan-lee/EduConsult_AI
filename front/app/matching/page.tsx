            ...
            <div className="flex-1 bg-white rounded-3xl border border-gray-200 shadow-sm flex flex-col overflow-hidden">
              ...
              <div className="p-4 bg-white border-t border-gray-100 flex gap-2">
                <input 
                  ...
                  className="flex-1 bg-gray-100 border-none rounded-xl px-4 py-2 text-sm text-gray-900 placeholder:text-gray-500 focus:ring-2 focus:ring-blue-500 transition"
